...
#ifndef HTMLDATASOURCE_H_
#define HTMLDATASOURCE_H_
...
/**
 * Clase que representa una fuente de datos tipo Html
 */
class HtmlDatasource : public suri::DatasourceInterface {
public:
   /** Constructor */
   HtmlDatasource();
   /** Destructor */
   virtual ~HtmlDatasource();
   /** Funcion estatica para crear un HtmlDatasource */
   static HtmlDatasource* Create(const std::string &FileName);
   /** Funcion estatica para crear un HtmlDatasource */
   static HtmlDatasource* Create(const wxXmlNode* pRootNode);
   /** Funcion estatica para crear un HtmlDatasource \deprecated */
   static HtmlDatasource* Create(Element* pElement);
   /** Funcion estatica para crear un DatasourceInterface */
   static HtmlDatasource* Create(DatasourceInterface *pDatasource);
