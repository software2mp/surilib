/*! \file PhotoHtmlRepresentationGetter.h */                                                     
/**                                                                                                 
 ...
 *                                                                                                  
*/ 
#ifndef __PHOTO_HTML_FILE_REPRESENTATION_H__
#define __PHOTO_HTML_FILE_REPRESENTATION_H__
...
**/
class PhotoHtmlRepresentationGetter : public ElementHtmlRepresentationGetter {
   /** ctor copia **/
   PhotoHtmlRepresentationGetter(const PhotoHtmlRepresentationGetter&);

public:
   /** ctor default **/
   PhotoHtmlRepresentationGetter();
   /** dtor */
   virtual ~PhotoHtmlRepresentationGetter();
...
#endif   // __PHOTOPHOTO_HTML_FILE_REPRESENTATION_H__
