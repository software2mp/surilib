...
#ifndef MULTIMEDIALAYER_H_
#define MULTIMEDIALAYER_H_

#include "suri/LayerInterface.h"

namespace suri {

class MultimediaLayer : public suri::LayerInterface {
public:
	/** Constructor \deprecated */
	MultimediaLayer(DatasourceInterface *pDatasource, Element *pElement);
	/** Constructor*/
	explicit MultimediaLayer(DatasourceInterface *pDatasource);
	virtual ~MultimediaLayer();
...
private:
	...
	MultimediaLayer(const MultimediaLayer &);
