/*! \file HideLayerCommandCreator.h */                                                     
/**                                                                                                 
...
#ifndef __HIDE_LAYER_COMMAND_CREATOR_H__
#define __HIDE_LAYER_COMMAND_CREATOR_H__
 ...
 **/
class HideLayerCommandCreator : public CommandCreatorInterface {
	/** ctor copia **/
	HideLayerCommandCreator(const HideLayerCommandCreator&);

public:
	/** constructor **/
	HideLayerCommandCreator();
	/** destructor **/
	~HideLayerCommandCreator();
